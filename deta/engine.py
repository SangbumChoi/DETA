...
import torch
from deta.datasets.coco_eval import CocoEvaluator
from deta.datasets.data_prefetcher import data_prefetcher
from deta.datasets.panoptic_eval import PanopticEvaluator
